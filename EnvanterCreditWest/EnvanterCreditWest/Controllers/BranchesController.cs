...
namespace EnvanterCreditWest.Controllers
{
    public class BranchesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Latitude,Longitude")] Branches branches)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Latitude,Longitude")] Branches branches)
        {
            if (ModelState.IsValid)
            {
